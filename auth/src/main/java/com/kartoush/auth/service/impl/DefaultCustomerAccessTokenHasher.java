...
@Component
public class DefaultCustomerAccessTokenHasher implements CustomerAccessTokenHasher {
    ...
    public String hash(final String rawToken) {
        try {
            ...
            throw new IllegalStateException("Unable to hash customer access token", exception);
        }
    }
}
